...
{
    public class ViewModelEM4325PassiveInventory : BaseViewModel
    {
        public class EM4325PassiveTagInfoViewModel : BindableBase
        {
            private string _EPC;
            public string EPC { get { return this._EPC; } set { this.SetProperty(ref this._EPC, value); } }

            private string _BAP;
            public string BAP { get { return this._BAP; } set { this.SetProperty(ref this._BAP, value); } }
        ...
        public ICommand OnReadTempCommand { protected set; get; }

        private ObservableCollection<EM4325PassiveTagInfoViewModel> _TagInfoList = new ObservableCollection<EM4325PassiveTagInfoViewModel>();
        public ObservableCollection<EM4325PassiveTagInfoViewModel> TagInfoList { get { return _TagInfoList; } set { SetProperty(ref _TagInfoList, value); } }
        ...
        public ViewModelEM4325PassiveInventory(IAdapter adapter, IUserDialogs userDialogs, IMvxNavigationService navigation) : base(adapter)
        {
            ...
            OnReadTempCommand = new Command(ReadTempClick);
        }

        ~ViewModelEM4325PassiveInventory()
        {
        }
        ...
        void InventorySetting()
        {
            ...
            BleMvxApplication._reader.rfid.Options.TagRanging.offset1 = 0x10d; // 0x10d = BAP
        ...
        private void AddOrUpdateTagData(CSLibrary.Structures.TagCallbackInfo info)
        {
            ...
            lock (TagInfoList)
            {
                ...
                {
                    EM4325PassiveTagInfoViewModel item = new EM4325PassiveTagInfoViewModel();

                    item.EPC = EPC;
                    item.BAP = ((info.Bank1Data[0] & 0x01) != 0) ? "Enable" : "Disable";
        ...
        private void ReadTempClick()
        {
            _navigation.Navigate<ViewModelEM4325PassiveReadTemp>(new MvxBundle());
        }
