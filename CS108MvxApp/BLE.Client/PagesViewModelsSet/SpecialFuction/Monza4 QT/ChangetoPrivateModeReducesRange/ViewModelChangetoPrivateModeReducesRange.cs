...
{
    public class ViewModelChangetoPrivateModeReducesRange : BaseViewModel
    {
        ...
        public ViewModelChangetoPrivateModeReducesRange(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
