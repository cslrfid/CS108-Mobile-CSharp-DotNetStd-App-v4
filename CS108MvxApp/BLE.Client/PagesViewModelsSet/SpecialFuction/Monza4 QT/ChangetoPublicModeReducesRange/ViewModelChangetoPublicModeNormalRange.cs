...
{
    public class ViewModelChangetoPublicModeReducesRange : BaseViewModel
    {
        ...
        public ViewModelChangetoPublicModeReducesRange(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
