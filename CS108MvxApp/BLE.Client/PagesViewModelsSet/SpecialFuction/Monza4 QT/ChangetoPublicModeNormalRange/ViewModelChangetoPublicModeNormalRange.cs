...
{
    public class ViewModelChangetoPublicModeNormalRange : BaseViewModel
    {
        ...
        public ViewModelChangetoPublicModeNormalRange(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
